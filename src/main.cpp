...
#if defined(NDEBUG)
# error "c0fferCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "c0fferCoin Signed Message:\n";
...
#ifdef ENABLE_WALLET
// c0fferCoin: attempt to generate suitable proof-of-stake
...
{
    RenameThread("c0fferCoin-loadblk");
